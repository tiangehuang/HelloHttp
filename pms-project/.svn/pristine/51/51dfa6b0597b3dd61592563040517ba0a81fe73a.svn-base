...
/*		String projectId = (String) condition.get("projectId");
	 ...
	 */
	@Override
	public List<Map<String, Object>> getWeeksByPeriod(Map<String, Object> condition) {
	 ...
	 */
	@Override
	public List<Map<String, Object>> getProjectName(Map<String, Object> condition) {
		List<Map<String,Object>> workloadsList = workWeeklyMapper.getProjecNameByProjTeam(condition);
		return workloadsList;
	}
	/**
	 * 导出周报信息
	...
	public boolean downLoadWeeklyReport(String path,Map<String, Object> condition) {
		...
		String fileName = "";
		if(condition.get("projectName") == null){
			fileName = "项目周报.xlsx";
		}else{
			fileName = condition.get("projectName")+"项目周报.xlsx";
		}
	...
	public String getProjectNameById(String id) {	
		return workWeeklyMapper.getProjNameById(id);
	}
	@Override
	public void deleteWeekly(Map<String, Object> condition)
	{
		workWeeklyMapper.deleteWeekly(condition);
